...
const Card: React.FC<CardProps & { columnId: string }> = (props) => {
  ...
  const toggleEdit = async (key: keyof EditableI, isBlurEvent: boolean = false): Promise<any> => {
      ...
      <Flex align="center" justify="space-between">
        {editable.title
          ...
          : <Heading
            ...
            {card.title === '' ? <Text color='#ccc'>Edit title</Text> : card.title}
        </Heading>
        }
        {editable.label
          ? <Input
          ...
          onClick={() => {
            ...
            {card.label === '' ? <Text color='#ccc'>Edit label</Text> : card.label}
          </Heading>
        }
      </Flex>
      ...
      <Flex mt={1} align="center" justify="space-between">
        {editable.description
          ...
          : <Heading
            ...
            {card.description === '' ? <Text color='#ccc'>Edit description</Text> : card.description}
            </Heading>}
